...
# 版本資訊
  ...
  * 修正 TG → Line 貼圖在 "🏀來源連結" 模式下傳送失敗(抵銷v3.3.3)       
  ...
  > 程式碼本身沒問題 ( ˘･з･)    
  > **如果又有發生這樣的狀況請 等一陣子(我測試約2分鐘)再發同一張貼圖**。
  >未來程式應該會主動解決這個問題。(可能自架圖床解決，最近google一直出問題r...)
  ...
  * 修正 up_version出錯      
  ...
  如果你已經升級的話，請額外執行以下步驟:
  1. download_from_line資料夾(["準備"中第3點有提到的資料夾](https://github.com/we684123/Telegram_link_Line#%E6%BA%96%E5%82%99))內，除了 "檔案放置區" 其他通通刪掉。([如圖](https://imgur.com/7NHVKZf))
  2. 去 sheet -> "JSON備份"，找到舊的備份(看一下日期時間喔)，複製後覆寫進doc。     
  **如果沒有備份** 的話請去doc，將[這張圖](https://imgur.com/nZ0kFUO)中的藍色部分刪掉 **(從 "逗點" 開始，最後的 "}" 沒刪掉)**，紅色的部分改3.2     
  3. gs執行 up_version() 函式    
  4. 如果 up_version() 執行完沒問題的話，再對 TGbot 下 /main + /debug。
  這樣就OK了。    
  ...
  ****
  ...
  ##### 2019/08/20 - ([V3.3](https://github.com/we684123/Telegram_link_Line/releases/tag/V3.3%E7%99%BC%E5%B8%83))     
  "🔧更多設定" 內:
  * 新增 "🍭變換房位" 功能
    可以自由調換主選單的房間位置
  * 新增 "🆗設定提示" 功能
...
>  2. TG bot 傳送 "檔案" 時，"檔案名稱"要是含有中文，中文的部分顯示不出來    
(覺得TG的問題，我之後盡量嘗試修補)    
  ...
  ****
  ...
  ##### 2019/07/27 - (hotfix)([V3.2.6](https://github.com/we684123/Telegram_link_Line/releases/tag/V3.2.6(hotfix)))     
  * 修正 (hotfix)(V3.2.5) 造成 bot 停擺的問題

  對不起 。･ﾟ･(つд\`ﾟ)･ﾟ･
  我下次一定會先過 autotest 才放上來
 ...
 ****
  ...
  ##### 2019/02/21 - ([V3.2.3](https://github.com/we684123/Telegram_link_Line/releases/tag/V3.2.3))     
  ...
  ****
  ...
  ##### 2019/01/11 - ([V3.2.2](https://github.com/we684123/Telegram_link_Line/releases/tag/V3.2.2))     
   * 修正 電腦版圖片無法下載的問題    
  ...
  ##### 2018/12/27 - (hotfix)([V3.2.1](https://github.com/we684123/Telegram_link_Line/releases/tag/V3.2.1(hotfix)))     
  ...
  ##### 2018/12/14 - ([V3.2](https://github.com/we684123/Telegram_link_Line/releases/tag/V3.2%E7%99%BC%E5%B8%83))     
   * 支援 File 傳送至 Line。    
